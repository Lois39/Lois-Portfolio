...
const projects = [
  ...
  },
 {
  ...
  category: 'Advanced Websites',
  description:
    'Elegant and fully responsive restaurant website featuring an interactive menu, online table reservations, and dynamic chef specials section.',
  image: portfolio3,
...
},
 {
  ...
  category: 'Advanced Websites',
  description:
    'Immersive manga reading platform with a vast library, high-resolution pages, customizable reading modes, and user favorites tracking.',
  image: portfolio4,
...
},
{
  ...
  category: 'Dashboards',
  description:
    'Comprehensive admin dashboard for managing manga uploads, chapters, genres, user accounts, and analytics with real-time updates.',
  image: portfolio5, 
  tech: ['React', 'Tailwind CSS', 'TypeScript'],
...
export default function Portfolio() {
      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {filteredProjects.map((project, index) => (
            <Card 
              key={project.id}
              className="card-glow group hover-glow overflow-hidden animate-fade-in"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
 ...
 <div className="absolute inset-0 bg-primary/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
  <a
    ...
    className="btn-glow inline-flex items-center px-4 py-2 rounded"
  >
    ...
    Live Demo
              ...
              <div className="p-4 sm:p-6">
                ...
                <h3 className="text-xl font-bold mb-3 glow-text group-hover:text-primary transition-colors">
                  {project.title}
                </h3>
  ...
  target="_blank"
  rel="noopener noreferrer"
  className="btn-glow w-full inline-flex items-center justify-center px-4 py-2 rounded"
>
